...
export const authorListInputSchema = listInputSchema.extend({
  type: z.nativeEnum(AuthorType).array().optional(),
});
export type AuthorListInputSchema = z.infer<typeof authorListInputSchema>;

export const authorUpdateProfileInputSchema = z.object({
  name: z.string(),
