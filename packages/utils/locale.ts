...
import { getRandomArrangeValues } from './random';
...
export const getRandomLocaleStringList = (): string[] => getRandomArrangeValues(getLocaleStringList());
export const getRandomCountries = (): string[] => getRandomArrangeValues(Object.keys(countries));
