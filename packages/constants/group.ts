...
export const PresetGroupNames = { ...PermanentPresetGroupNames, ...PersistentPresetGroupNames } as const;
export type PresetGroupNames = (typeof PresetGroupNames)[keyof typeof PresetGroupNames];
